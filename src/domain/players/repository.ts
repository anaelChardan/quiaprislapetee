...
export interface PlayersRepository {
  save(player: Player): Promise<Result<{ error: unknown }, { id: PlayerId }>>;
  ...
  upsert(player: Player): Promise<Result<{ error: unknown }, { id: PlayerId }>>;
  bulkUpsert(players: Player[]): Promise<Result<{ error: unknown }, { id: PlayerId }[]>>;
